 ...
 *
 * "root" is the root of the schedule tree and may be NULL if this
 * schedule was not created from a schedule tree.
 * On the other hand, if "root" is not NULL, then the other members,
 * except leaf, are uninitialized.
 *
