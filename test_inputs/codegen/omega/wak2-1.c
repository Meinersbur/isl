    ...
    for (int c0 = a2, c0_end = b2; c0 <= c0_end; c0 += 1) {
      if (a1 >= c0 + 1) {
        ...
        for (int c1_0 = c1, c1_0_end = min(d1, c2 - 1); c1_0 <= c1_0_end; c1_0 += 1)
          s0(c0, c1_0);
        for (int c1_0 = c2, c1_0_end = min(c1 - 1, d2); c1_0 <= c1_0_end; c1_0 += 1)
          s1(c0, c1_0);
        for (int c1_0 = max(c1, c2), c1_0_end = min(d1, d2); c1_0 <= c1_0_end; c1_0 += 1) {
          s0(c0, c1_0);
          s1(c0, c1_0);
        }
        for (int c1_0 = max(c1, d2 + 1), c1_0_end = d1; c1_0 <= c1_0_end; c1_0 += 1)
          s0(c0, c1_0);
        for (int c1_0 = max(max(c1, d1 + 1), c2), c1_0_end = d2; c1_0 <= c1_0_end; c1_0 += 1)
          s1(c0, c1_0);
      }
    }
