for (int c0 = 0; c0 <= max(0, m - 1); c0 += 32)
  if (m >= c0 + 1)
    for (int c1 = (n >= 32 && m >= c0 + 2) || (m == 1 && c0 == 0) ? 0 : 32 * n - 32 * floord(31 * n + 31, 32); c1 <= ((n <= -1 && c0 == 0) || (m == 1 && n >= 0 && c0 == 0) ? max(0, n - 1) : n); c1 += 32)
      for (int c2 = c0; c2 <= (m >= 2 && c0 + 31 >= m && n >= c1 && c1 + 31 >= n ? 2 * m - 3 : (m >= 2 * c0 + 63 && c1 <= -32 && n >= c1 && c1 + 31 >= n) || (m >= c0 + 32 && 2 * c0 + 62 >= m && n >= c1 && c1 + 31 >= n) || (n >= 0 && c0 >= 32 && m >= 2 * c0 + 63 && c1 == n && n % 32 == 0) || (m >= 63 && n >= 32 && c0 == 0 && c1 == n && n % 32 == 0) ? 2 * c0 + 61 : m - 1); c2 += 32) {
        if (c1 >= n) {
          if (c0 == 0 && c1 == 0)
